...
pos2 = pos
pos3 = pos
servo_com1 = map(pos1,0.0,360.0,0,4095)
servo_com2 = map(pos2,0.0,360.0,0,4095)
servo_com3 = map(pos3,0.0,360.0,0,4095)
...
set_A_PRFL = 3      # between 0 ~ set_A_limit      [214.577 rev/min^2]
set_V_PRFL = 20       # between 0 ~ set_V_Limit      [0.229RPM]
