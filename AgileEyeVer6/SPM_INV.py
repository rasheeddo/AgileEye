...
set_A_PRFL = 120     # between 0 ~ set_A_limit      [214.577 rev/min^2]
set_V_PRFL = 250       # between 0 ~ set_V_Limit      [0.229RPM]
...
print("time=%f" %period)
print("roll=%d" %(r*rad2deg))
print("pitch=%d" %(p*rad2deg))
print("yaw=%d" %(y*rad2deg))
print("deg1=%f" %DEG1)
print("deg2=%f" %DEG2)
print("deg3=%f" %DEG3)
...
try:
	while True:
		...
		if Moving1 == 1 or Moving2 == 1 or Moving3 == 1:
			print("I am moving!")
		else:
